...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 19:08:48 GMT -->

<head>
    <meta charset="utf-8">
    <title>SignUP | Royal Infra</title>
                        ...
                        <div class="account__form">
                            <form action="#">
                                ...
                                <div class="account__form--input mb-30">
                                    ...
                                    <div class="account__form--create__password position-relative">
                                        <input class="account__form--input__field" id="password" placeholder="Confirm password" type="password">
                                        <!-- <button class="account__form--password__show--icon"><svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8 10C2.76587 10 0.170875 5.437 0.063 5.24288C-0.021 5.09175 -0.021 4.90812 0.063 4.757C0.170875 4.563 2.76587 0 8 0C13.2341 0 15.8291 4.563 15.937 4.75712C16.021 4.90825 16.021 5.09188 15.937 5.243C15.8291 5.437 13.2341 10 8 10ZM1.08837 4.99925C1.68313 5.90062 4.01825 9 8 9C11.9944 9 14.3191 5.90312 14.9116 5.00075C14.3169 4.09937 11.9818 1 8 1C4.00562 1 1.68087 4.09688 1.08837 4.99925ZM8 8C6.34575 8 5 6.65425 5 5C5 3.34575 6.34575 2 8 2C9.65425 2 11 3.34575 11 5C11 6.65425 9.65425 8 8 8ZM8 3C6.89725 3 6 3.89725 6 5C6 6.10275 6.89725 7 8 7C9.10275 7 10 6.10275 10 5C10 3.89725 9.10275 3 8 3Z" fill="#817F7E"></path>
                                            </svg>
                                        </button> -->
                                ...
                                <div class="advance__search--box__items account__form--input">
                                    ...
                                    <div class="select">
                                        <select class="advance__search--select__field">
        ...
        <div class="social__media--area bg__style">
            <ul class="social__media--wrapper d-flex">
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://www.facebook.com/"> <svg width="9" height="18" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://twitter.com/"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                ...
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://www.instagram.com/"> <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://www.youtube.com/"> <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://www.whatsapp.com/"> <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="social__media--list">
                    <a class="social__media--link" target="_blank" href="https://www.pinterest.com/"> <svg width="14" height="16" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-xl-3 col-lg-5 col-md-6">
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget--inner">
                                    ...
                                    <p class="footer__widget--desc">The world’s first and largest digital market for crypto collectibles and non-fungible (NFTs). Buy</p>
                                    <ul class="footer__widget--info">
                                        <li class="footer__widget--info_list">
                                            ...
                                            <p class="footer__widget--info__text">86 Road Broklyn Street, 600 New York, USA</p>
                                        </li>
                                        <li class="footer__widget--info_list">
