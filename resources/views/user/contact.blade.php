                ...
                <div class="contact__inner">
                    <div class="contact__wrapper mb-80 d-flex">
                            ...
                            <div class="contact__us--info__list d-flex align-items-center">
                                ...
                                <div class="contact__us--info__content">
                                    ...
                                    <p class="contact__us--info__text">
                                        <a href="mailto:info@example.com">info@royalinfra.finance </a> <br>
                        ...
                        <div class="contact__us--map" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.3321295315613!2d73.1517690747495!3d22.303275442788593!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc9ac99bb7bb5%3A0x11b3016b896945a3!2sSampat%20Square!5e0!3m2!1sen!2sin!4v1740469269308!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                            ...
                            <div class="row mb--n30">
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="contact__form--input position-relative">
                                        <input class="contact__form--input__field" placeholder="Enter Your Name*" type="text" name="name" value="{{old('name')}}">
                                ...
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="contact__form--input position-relative">
                                        <input class="contact__form--input__field" placeholder="Enter Email Address*" type="email" name="email" value="{{old('email')}}">
                                ...
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="contact__form--input select">
                                        <select class="contact__form--select" name="property_type">
                                ...
                                <div class="col-lg-6 col-md-6 mb-30">
                                    <div class="contact__form--input position-relative">
                                        <input class="contact__form--input__field" placeholder="Enter Phone Number" type="number" name="contact" value="{{old('contact')}}">
                                ...
                                <div class="col-12 mb-30">
                                    <div class="contact__form--textarea position-relative">
                                        <textarea class="contact__form--textarea__field" placeholder="Enter Your Messege here" name="message">{{old('message')}}</textarea>
