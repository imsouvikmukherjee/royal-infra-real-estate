    ...
    <div class="container">
        <div class="contact__information--aera d-flex" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
            <div class="contact__information--email d-flex align-items-center justify-content-center">
                ...
                <p class="contact__information--email__text">Contact us at <a href="mailto:info@royalinfra.finance">info@royalinfra.finance</a> </p>
            ...
            <div class="row ">
                    ...
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget--inner">
                            <div class="footer__logo">
                                <a class="footer__logo--link display-block" href="{{route('user_home')}}">
                                    <img class="footer__logo--img" src="assets/img/royalinfranew.png" style="max-width: 90px;" alt="logo-img">
                                </a>
                            </div>
                            <p class="footer__widget--desc">At Royal Infra, we transform land into thriving communities. Whether it's your dream home or a prime commercial space, we deliver quality, innovation, and lasting value.</p>
                            <ul class="footer__widget--info">
                                <li class="footer__widget--info_list">
                                    ...
                                    <p class="footer__widget--info__text">G 301, 302, Sampat Square
                                        Opp- R.K. Mall plaza Near- Utkarsh School
                                        New court Road, Diwalipura
                                        Vadodara, Gujrat</p>
                                </li>
                                <li class="footer__widget--info_list">
                                    ...
                                    <a class="footer__widget--info__text" href="mailto:example@example.com">info@royalinfra.finance</a>
                                </li>
                                <li class="footer__widget--info_list">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Property on sale</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Team membar</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Offices for Buy</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Terms of use</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Offices for Rent</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-4">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Help/FAQ</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Propert owners</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Contact Support</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Pricing Plans</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Partners</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-3 col-md-3">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">About Us</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Contact</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Services Details </a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Add Listing</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user_home')}}">Property</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer__bottom color-offwhite">
        <div class="container">
            <div class="footer__bottom--inner d-flex justify-content-between align-items-center">
                <p class="copyright__content mb-0"><span class="text__secondary">© 2025</span> Designed By <a class="copyright__content--link" target="_blank" href="https://microtechniqueit.com/">Microtechnique IT</a> . All Rights Reserved.</p>
...
<!-- Mirrored from risingtheme.com/html/demo-newvilla/newvilla/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 19:07:19 GMT -->
